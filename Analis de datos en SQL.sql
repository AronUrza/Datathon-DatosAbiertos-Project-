...
SELECT
	...
	FROM DAPROJECT WHERE PERIODO = 202403) AS Participacion_Mercado
FROM DAPROJECT 
...
SELECT
    PERIODO, EMPRESA,
    (SUM(CANT_CONEXIONES) * 100.0) / (SELECT SUM(CANT_CONEXIONES) 
	FROM DAPROJECT WHERE PERIODO = 202312) AS Participacion_Mercado
FROM DAPROJECT 
...
SELECT
    PERIODO, EMPRESA,
    (SUM(CANT_CONEXIONES) * 100.0) / (SELECT SUM(CANT_CONEXIONES) 
	FROM DAPROJECT WHERE PERIODO = 202309) AS Participacion_Mercado
FROM DAPROJECT 
...
SELECT
    PERIODO, EMPRESA,
    (SUM(CANT_CONEXIONES) * 100.0) / (SELECT SUM(CANT_CONEXIONES) 
	FROM DAPROJECT WHERE PERIODO = 202306) AS Participacion_Mercado
FROM DAPROJECT 
WHERE PERIODO = 202306 
GROUP BY PERIODO, EMPRESA


ORDER BY Participacion_Mercado DESC,EMPRESA ;
